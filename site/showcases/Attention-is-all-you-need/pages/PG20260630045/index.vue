...
const columns = [
  { key: 'layerType', title: '层类型', width: '240px', align: 'left' },
  { key: 'complexity', title: '单层复杂度', width: '220px', align: 'center' },
  { key: 'seqOps', title: '最少顺序操作数', width: '200px', align: 'center' },
  { key: 'maxPath', title: '最大路径长度', width: '200px', align: 'center' },
]
