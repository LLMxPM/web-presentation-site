    ...
    <div class="h-full w-full flex gap-6 px-8 pt-2">
      ...
      <div class="w-[560px] shrink-0 flex flex-col gap-3">
        ...
        <div class="bg-accent2/10 rounded-lg p-3 border border-accent2/30">
          <p class="text-base text-primary leading-relaxed text-center">
            📌 论文贡献 <strong class="text-accent2">不只靠架构</strong>，还包括关键的训练 recipe：warmup、label smoothing、dropout、checkpoint averaging。
          </p>
        </div>
      </div>
      ...
      <div class="flex-1 flex flex-col justify-center space-y-3">
        <div class="bg-background-subtle rounded-lg p-4 border border-border-subtle">
          <h3 class="text-xl font-heading font-bold text-primary mb-2">📊 数据规模</h3>
        ...
        <div class="bg-background-subtle rounded-lg p-4 border border-border-subtle">
          <h3 class="text-xl font-heading font-bold text-primary mb-2">🖥️ 硬件与训练时长</h3>
          <div class="grid grid-cols-2 gap-3 text-sm">
        ...
        <div class="bg-background-subtle rounded-lg p-4 border border-border-subtle">
          <h3 class="text-xl font-heading font-bold text-primary mb-2">🛡️ 正则化策略</h3>
        ...
        <div class="bg-background-subtle rounded-lg p-4 border border-border-subtle">
          <h3 class="text-xl font-heading font-bold text-primary mb-2">🔍 推理策略</h3>
          <div class="space-y-1.5 text-base text-secondary">
