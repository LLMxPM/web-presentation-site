      ...
      <div class="flex-1 flex flex-col justify-center space-y-4">
        ...
        <div class="bg-background-subtle rounded-lg p-4 border border-border-subtle">
          ...
          <div class="space-y-1.5 text-lg text-secondary">
            <p><Icon name="search" class="size-5 inline-block align-middle" /> <strong class="text-primary">Query</strong>：当前 token「想找什么信息」</p>
            <p><Icon name="key" class="size-5 inline-block align-middle" /> <strong class="text-primary">Key</strong>：每个 token「能被匹配的索引」</p>
            <p><Icon name="package" class="size-5 inline-block align-middle" /> <strong class="text-primary">Value</strong>：真正要汇总的内容</p>
          </div>
        </div>

        <div class="bg-accent1/10 rounded-lg p-3 border border-accent1/30">
          <p class="text-base text-primary leading-relaxed">
            <Icon name="warning" class="size-5 inline-block align-middle" /> Decoder 中通过 mask 把非法未来位置设为 <code class="font-code text-accent1">-∞</code>，保证自回归生成。
          </p>
        </div>
      </div>
    </div>
